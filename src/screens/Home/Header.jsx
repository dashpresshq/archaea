          ...
          <div className="flex items-center lg:order-2">
            <div className="hidden mt-2 mr-4 sm:inline-block">
              <Link
                ...
                aria-label="Star hadmean/hadmean on GitHub"
              >
                Star
              </Link>
            </div>
            ...
            <Link
              ...
              className="text-primary dark:text-white hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-2 py-2 lg:py-2.5 mr-2 focus:outline-none dark:focus:ring-gray-800"
            >
              <svg
                className="w-5 h-5"
                fill="currentColor"
            ...
            <button
              ...
              type="button"
              className="inline-flex items-center pl-2 ml-1 text-sm text-gray-500 rounded-lg lg:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
